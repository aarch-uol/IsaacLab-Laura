...
#ifndef ROBOT_STATE_MESSAGE__SRV__DETAIL__RETURN_ROBOT_STATE__FUNCTIONS_H_
#define ROBOT_STATE_MESSAGE__SRV__DETAIL__RETURN_ROBOT_STATE__FUNCTIONS_H_
...
/// Initialize srv/ReturnRobotState message.
/**
...
/// Finalize srv/ReturnRobotState message.
/**
...
/// Create srv/ReturnRobotState message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_state_message__srv__ReturnRobotState_Request__init().
...
/// Destroy srv/ReturnRobotState message.
/**
 * It calls
 * robot_state_message__srv__ReturnRobotState_Request__fini()
...
/// Check for srv/ReturnRobotState message equality.
/**
...
/// Copy a srv/ReturnRobotState message.
/**
...
/// Initialize array of srv/ReturnRobotState messages.
/**
...
/// Finalize array of srv/ReturnRobotState messages.
/**
 * It calls
 * robot_state_message__srv__ReturnRobotState_Request__fini()
...
/// Create array of srv/ReturnRobotState messages.
/**
 * It allocates the memory for the array and calls
 * robot_state_message__srv__ReturnRobotState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReturnRobotState messages.
/**
 * It calls
 * robot_state_message__srv__ReturnRobotState_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReturnRobotState message array equality.
/**
...
/// Copy an array of srv/ReturnRobotState messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_state_message__srv__ReturnRobotState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state_message
...
/**
 * It calls
 * robot_state_message__srv__ReturnRobotState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state_message
...
/**
 * It allocates the memory for the array and calls
 * robot_state_message__srv__ReturnRobotState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_state_message
...
/**
 * It calls
 * robot_state_message__srv__ReturnRobotState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_STATE_MESSAGE__SRV__DETAIL__RETURN_ROBOT_STATE__FUNCTIONS_H_
