...
#ifndef MESSAGE_SERVER__SRV__DETAIL__GET_LATEST_MESSAGE__FUNCTIONS_H_
#define MESSAGE_SERVER__SRV__DETAIL__GET_LATEST_MESSAGE__FUNCTIONS_H_
...
#include "message_server/msg/rosidl_generator_c__visibility_control.h"

#include "message_server/srv/detail/get_latest_message__struct.h"

/// Initialize srv/GetLatestMessage message.
/**
...
/// Create srv/GetLatestMessage message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message_server__srv__GetLatestMessage_Request__init().
...
/// Destroy srv/GetLatestMessage message.
/**
 * It calls
 * message_server__srv__GetLatestMessage_Request__fini()
...
/// Check for srv/GetLatestMessage message equality.
/**
...
/// Copy a srv/GetLatestMessage message.
/**
...
/// Initialize array of srv/GetLatestMessage messages.
/**
...
/// Finalize array of srv/GetLatestMessage messages.
/**
 * It calls
 * message_server__srv__GetLatestMessage_Request__fini()
...
/// Create array of srv/GetLatestMessage messages.
/**
 * It allocates the memory for the array and calls
 * message_server__srv__GetLatestMessage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetLatestMessage messages.
/**
 * It calls
 * message_server__srv__GetLatestMessage_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetLatestMessage message array equality.
/**
...
/// Copy an array of srv/GetLatestMessage messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message_server__srv__GetLatestMessage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message_server
...
/**
 * It calls
 * message_server__srv__GetLatestMessage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_message_server
...
/**
 * It allocates the memory for the array and calls
 * message_server__srv__GetLatestMessage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message_server
...
/**
 * It calls
 * message_server__srv__GetLatestMessage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MESSAGE_SERVER__SRV__DETAIL__GET_LATEST_MESSAGE__FUNCTIONS_H_
