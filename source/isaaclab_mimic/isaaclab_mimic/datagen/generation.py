    ...
    with contextlib.suppress(KeyboardInterrupt) and torch.inference_mode():
        while True:
            ...
            if prev_num_attempts != num_attempts:
                ...
                summary_text=f"\n"
                summary_text+=f"Success Rate: {generated_sucess_rate:.1f}% ({num_success} successes, {num_failures} failures, {num_attempts} attempts)\n"
                summary_text+= "*" * 50 + "\n"
                summary_text+=f"{num_success}/{num_attempts} ({generated_sucess_rate:.1f}%) successful demos generated by mimic\n"
                # print(
