...
@configclass
class LlmStackIKRelBlueprintMimicEnvCfg(generated_llm, MimicEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_1",
                subtask_term_signal="reach_object1",
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_1",
                subtask_term_signal="object_grasped1",
                subtask_term_offset_range=(10, 20),
                selection_strategy="nearest_neighbor_object",
                selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_1",
                subtask_term_signal="is_object_lifted1",
                subtask_term_offset_range=(10, 20),
                selection_strategy="nearest_neighbor_object",
                selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_2",
                subtask_term_signal="reach_object2",
                subtask_term_offset_range=(10, 20),
                selection_strategy="nearest_neighbor_object",
                selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_1",
                subtask_term_signal="object_stacked",
                subtask_term_offset_range=(10, 20),
                selection_strategy="nearest_neighbor_object",
                selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01,
