...
class ObservationsCfg:
    ...
    class SubtasksCfg(ObsGroup):
        ...
        is_object_lifted_task1 = ObsTerm(func=mdp.is_object_lifted, params={"object_cfg": SceneEntityCfg("object1")})
        object_reached_midgoal_task1 = ObsTerm(func=mdp.object_reached_midgoal)
        reach_object2_task1 = ObsTerm(func=mdp.reach_object2, params={"object_cfg": SceneEntityCfg("object3")})
        pouring_solution1 = ObsTerm(func=mdp.pouring_solution)
        reorient_object1 = ObsTerm(func=mdp.reorient_object)
        object_stacked_task1 = ObsTerm(func=mdp.object_near_goal, params={"object_cfg": SceneEntityCfg("object1")})
