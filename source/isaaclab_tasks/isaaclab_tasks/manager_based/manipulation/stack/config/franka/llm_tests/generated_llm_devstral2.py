...
class FrankaCubeStackEnvCfg(StackEnvCfg):
    def __post_init__(self):
        ...
        # Spawn Glassware
        self.scene.object1 = glassware.beaker  # Main object for pouring a solution

        # Spawn Lab Equipment
        self.scene.object2 = glassware.hot_plate  # Target equipment for pouring the solution
