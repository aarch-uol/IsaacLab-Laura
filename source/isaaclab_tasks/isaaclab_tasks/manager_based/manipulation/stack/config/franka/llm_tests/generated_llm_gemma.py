...
class FrankaCubeStackEnvCfg(StackEnvCfg):
    def __post_init__(self):
        ...
        # Spawn Glassware
        self.scene.object1 = glassware.round_bottom_flask  # Main object - round_bottom_flask, used for stirring
        ...
        # Spawn Lab Equipment
        self.scene.hot_plate = glassware.hot_plate  # Used for stirring
