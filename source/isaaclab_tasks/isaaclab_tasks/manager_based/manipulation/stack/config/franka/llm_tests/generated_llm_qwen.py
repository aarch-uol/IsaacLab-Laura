...
class FrankaCubeStackEnvCfg(StackEnvCfg):
    def __post_init__(self):
        ...
        # Main object: beaker (task 1)
        self.scene.object1 = glassware.beaker  # Main object used for pouring solution

        # Target equipment: funnel (task 1)
        self.scene.object2 = glassware.funnel  # Equipment the main object interacts with during pouring
