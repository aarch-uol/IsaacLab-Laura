...
class EventCfg:
    ...
    randomize_cube_positions = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.4, 0.6), "y": (-0.10, 0.10), "z": (0.0203, 0.0203), "yaw": (-3.14, 3.14)},
            "asset_cfg": SceneEntityCfg("cube"),
        },
    )

    randomize_beaker_positions = EventTerm(
        func=franka_stack_events.randomize_object_pose,
        mode="reset",
        params={
            "pose_range": {"x": (0.4, 0.6), "y": (-0.10, 0.10), "z": (0.0203, 0.0203), "yaw": (-3.14, 3.14)},
